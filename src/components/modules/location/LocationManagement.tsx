...
import { resetAll, userManagementSelector } from './locationManagement.reducer';
import { getEntities } from './locaitonapi';
    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-center">
                <h2 className="mb-4 fw-bold text-24">Danh sách khu vực</h2>
                <button className='btn btn-primary' onClick={() => setVisibleCreateModal(true)}>Thêm khu vực</button>
            </div>
            <div>
                <CSmartTable
                    noItemsLabel={
