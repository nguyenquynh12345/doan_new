...
import { createEntity, getEntities, removeEntity, updateEntity } from './locaitonapi';
...
export const userManagementSelector = expertAdapter.getSelectors((state: RootState) => state.locationManagementReducer);

const getExpertState = (state: RootState) => state.locationManagementReducer;
