...
import { createEntity, getEntities, removeEntity, updateEntity } from './cateogries.api';
...
export const userManagementSelector = expertAdapter.getSelectors((state: RootState) => state.categoriesManagementReducer);

const getExpertState = (state: RootState) => state.categoriesManagementReducer;
