        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/buttons#button-components">
              <CButton color="primary" href="#" role="button">
                Link
              </CButton>
              <CButton type="submit" color="primary">
                Button
              </CButton>
              <CButton type="button" color="primary" value="Input" />
              <CButton type="submit" color="primary" value="Submit" />
              <CButton type="reset" color="primary" value="Reset" />
            </DocsExample>
          </CCardBody>
        </CCard>
      </CCol>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/buttons#disabled-state">
              <CButton href="#" color="primary" size="lg" disabled>
                Primary link
              </CButton>
              <CButton href="#" color="secondary" size="lg" disabled>
                Link
              </CButton>
            </DocsExample>
          </CCardBody>
